...
function scriptsMenu() {
    return src(['app/js/humburger.js']).pipe(concat('appMenu09.min.js')).pipe(uglify()).pipe(dest('app/js/')).pipe(browserSync.stream());
}

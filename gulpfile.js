...
function scriptsMenu() {
    return src(['app/js/humburger.js']).pipe(concat('appMenu10.min.js')).pipe(uglify()).pipe(dest('app/js/')).pipe(browserSync.stream());
}
